...
public class A7JediTest {
	...
	private IngredientPortion[] ingredients = new IngredientPortion[] { salmon, seaweed, rice };
	...
	public static String[] getTestNames() {
		return new String[] { "testRegisterCustomerAtPosition", "testRegisterCustomerNull",
				"testRegisterCustomerAtFullPosition", "testRegisterCustomerTwice", "testUnregisterCustomerAtPosition",
